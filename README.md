...
1. Build game from source code or [Download](https://github.com/tx00100xt/SeriousSamClassic/release) and copy the latest files from the game directory to SamTFE/Bin
